...
var $author$project$Imcgss$UnitFinder$Finder$find = function (performers) {
	return $elm$core$List$reverse(
		A2(
			...
			$author$project$Imcgss$UnitFinder$Finder$foundUnitComparison,
			A2(
...
var $author$project$Imcgss$UnitFinder$Tool$trim = function (str) {
	return A3(
...
var $author$project$Imcgss$UnitFinder$Main$coverageView = function (coverage) {
	return $elm$core$String$fromInt(
		$elm$core$Basics$round(coverage * 100)) + '%';
};
...
var $author$project$Imcgss$UnitFinder$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onSubmit($author$project$Imcgss$UnitFinder$Main$Submit)
					]),
				_List_fromArray(
					[
						A2(
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									$author$project$Imcgss$UnitFinder$Main$ChooseLive(live))
								]),
							_List_fromArray(
								[
